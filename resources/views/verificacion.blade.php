        ...
        <div class="card">
            ...
            <div class="card-body">
                @if (isset($verificar))
                    ...
                    {{-- Fecha de Resolución --}}
                    @if(!empty($verificar->CerFecCer) && $verificar->CerFecCer != '1753-01-01')
                    ...
                    @if(!empty($verificar->CerReLFe) && $verificar->CerReLFe != '1753-01-01')
                    ...
                    {{-- Valido Hasta --}}
                    @if(!empty($verificar->CerVto) && $verificar->CerVto != '1753-01-01')
