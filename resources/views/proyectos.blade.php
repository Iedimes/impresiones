            ...
            <form action="/filtros" method="post">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="resid" value="{{ old('resid', isset($resid) ? $resid : '') }}"
                            name="resid" class="form-control" placeholder="Ingrese Resolución">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <tbody>
                @foreach ($projects as $project)
                    <tr>
                        ...
                        <td style="text-align:center;">
                            @if ($project->CerPin == null || $project->CerPin == 0)
                                <a href="{!! action('HomeController@previaimpresion', [
                                    'id' => $project->CerNro,
                                    'progid' => $progid,
                                    'resid' => $resid,
                                    'dateid' => $dateid,
                                    ...
                                    <button class="btn btn-success" type="button"><i class="fa fa-print"></i> Imprimir
                                    </button>
                                </a>
                            @else
                                <a href="{!! action('HomeController@previaimpresion', [
                                    ...
                                    <button class="btn btn-danger block" type="button"><i class="fa fa-print"></i> Re
                                        Imprimir </button>
                                </a>
                            @endif
                        </td>
